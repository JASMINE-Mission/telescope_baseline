...
def test_from_detector_image_catalogue():
    ...
    builder = StellarImageBuilder(9, 128, 128)
...
def test_from_on_tye_sky_position():
    builder = StellarImageBuilder(9, 256, 256)
    s = SkyPosition(1, SkyCoord(l=0, b=0, unit=('deg', 'deg'), frame='galactic'), 3000, Time('2000-01-01 00:00:00'))
    o = OnTheSkyPosition([s])
    w = WCS(naxis=2)
